...
ozone_rds_file <- "data/derived/ozone_summary_tables/impacts_ozone_summarised_no_interaction.rds"

figure_dir <- "figures/ozone/supplementary"
...
# The plotting function is identical but can be modified for non-interaction scenario
...
ggsave(file.path(figure_dir,"Ozone_Impact_Map_NoInteraction.pdf"), patch, width=10, height=12)
ggsave(file.path(figure_dir,"Ozone_Impact_Map_NoInteraction.tif"), patch, width=10, height=12, dpi=600)