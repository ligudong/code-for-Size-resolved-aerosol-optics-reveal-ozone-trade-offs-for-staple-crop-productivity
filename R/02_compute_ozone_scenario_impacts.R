# File: R/02_compute_ozone_scenario_impacts.R
...
# Load ozone impact raster data
ozone <- qread(file.path(output_dir,"impacts_ozone_AOT40.qs"), nthreads = qn)
...
# Save results
saveRDS(ozone, file.path(output_dir,"impacts_ozone_summarised_faod.rds"))