...
derived – Intermediate processed datasets and outputs generated from analyses. A demo dataset (tidied_demo.qs) is also provided, which preserves the data structure and key variables of the full dataset, allowing users to test and validate the analysis workflow without accessing the complete data.
